...
>[!NOTE]
>You can copy paste the code for this step if its already given, regardless make sure you change the file paths such that they match with your own device.
